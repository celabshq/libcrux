...
#[cfg_attr(
    ...
    array_from_fn (sz 256) (fun i -> Spec.MLKEM.Math.to_spec_fe 
...
let to_spec_vector_t (#r:Spec.MLKEM.rank) (#v_Vector: Type0)
    ...
    array_from_fn r (fun i -> to_spec_poly_t #v_Vector (m.[i]))
let to_spec_matrix_t (#r:Spec.MLKEM.rank) (#v_Vector: Type0)
    ...
    array_from_fn r (fun i -> to_spec_vector_t #r #v_Vector (m.[i]))
