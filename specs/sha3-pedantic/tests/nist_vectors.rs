//! Ported from ../../sha3/tests/nist_vectors.rs, the byte-level spec's suite.
...
fn shake256_empty_64() {
    ...
    assert_eq!(shake256(b"", 64).to_vec(), expected);
}
