...
- [#XXXX](https://github.com/celabshq/libcrux/pull/XXXX): `generate_key_pair`'s output-buffer length check is now enforced in release builds (was `debug_assert!`-only)
