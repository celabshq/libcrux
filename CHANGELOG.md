...
- (libcrux-kem) [#XXXX](https://github.com/celabshq/libcrux/pull/XXXX): Reject invalid/short seed lengths in `PublicKey::encapsulate_derand` without panicking; Return `Ss::MlKem512` variant instead of `Ss::MlKem768` variant when decapsulating `Ct::MlKem512` ciphertext
