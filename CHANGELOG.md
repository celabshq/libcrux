...
- (libcrux-sha3) [#1597](https://github.com/celabshq/libcrux/pull/1597): `hash::<LEN>` now enforces its length preconditions with a release-mode `assert!` instead of a `debug_assert!`, preventing a silently truncated/wrong-algorithm digest
